"use strict";
cc._RF.push(module, '01210kXYAlPXo8mtdTYGmFY', 'Game');
// script/Game.js
...
cc.Class({
  ...
  getNewStarPosition: function getNewStarPosition() {
    ...
    var randY = this.groundY + Math.random() * this.player.getComponent('Player_Move').jumpHeight + 50; // 根据屏幕宽度，随机得到一个星星 x 坐标
